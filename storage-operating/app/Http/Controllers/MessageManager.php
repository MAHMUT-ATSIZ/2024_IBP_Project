...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function usermessageChatPost(Request $request) {
        $validatedData = $request->validate([
            'message' => 'required',
            'sender_id' => 'required',
            'receiver_id' => 'required',
        ...
        if(!$message){
            ...
            return view('pages.usermessageChat', compact('message_sender', 'messages','conversations'));
    }
    ...
    function userMessages() {
        ...
        return view('pages.usermessages', compact('conversations'));
    }

    function usermessageChat(Request $request) {
        $userId = Auth::id();
        ...
        return view('pages.usermessageChat', compact('messages', 'conversations', 'userId'));
    }
