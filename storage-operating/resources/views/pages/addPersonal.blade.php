...
@section('title3', 'Personel Ekle')

@section('content')<div class="container d-flex justify-content-center align-items-center">
    <div class="col-lg-5 col-md-6">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-dark text-white text-center">
                <h3 class="card-title m-0">Personel Bilgileri</h3>
            </div>
            <form action="{{ route('addPersonal.post') }}" method="post">
                @csrf
                ...
                <div class="card-footer bg-light text-end">
                    <button style="background-color: gray" type="submit" class="btn btn-primary">Personel Oluştur</button>
                </div>
            </form>
        </div>
    </div>
