...
@section('title', 'Depo Güncelle')
@section('title2', 'Depo İşlemleri')
@section('title3', 'Depo Güncelle')
        ...
        <div class="col-md-8">
            <div class="card border-secondary shadow-lg">
                <div class="card-header bg-secondary text-white d-flex align-items-center">
                    ...
                    <h3 class="card-title mb-0">Güncellenecek Depo Bilgileri</h3>
                </div>
                <form action="{{ route('updateWarehouse.post') }}" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="form-group mb-3">
                            <label for="name" class="form-label">Güncellenecek Depo İsmi:</label>
                    ...
                    <div class="card-footer text-end">
                        <button type="submit" class="btn btn-success">
                            <i class="fas fa-plus-circle me-2"></i>&nbsp; &nbsp; Depoyu Güncelle
                        </button>
                    </div>
                </form>
            </div>
