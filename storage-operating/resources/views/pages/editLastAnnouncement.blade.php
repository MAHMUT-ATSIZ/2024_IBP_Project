        ...
        <div class="col-md-8">
            <div class="card border-primary shadow-lg">
                <div class="card-header bg-primary text-white d-flex align-items-center">
                    ...
                    <h3 class="card-title mb-0">Güncellenecek Duyuru Bilgileri</h3>
                </div>
                <form action="{{ route('editLastAnnouncement.post') }}" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="form-group mb-3">
                            <label for="tittle" class="form-label">Güncellenecek Duyuru Başlığı:</label>
                    ...
                    <div class="card-footer text-end">
                        <button type="submit" class="btn btn-success">
                            <i class="fas fa-plus-circle me-2"></i>Duyuru Güncelle
                        </button>
                    </div>
                </form>
            </div>
